<template lang="">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu">
                    ...
                    <div class="app-brand demo ">
                        ...
                        <a href="javascript:void(0);" @click="toggleMenu" class="layout-menu-toggle menu-link text-large ms-auto">
                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item" :class="MainMenu1 + MainM1">
                            <router-link to="/home" class="menu-link"
                                @click="MainMenu1?MainMenu1='' :MainMenu1='active'; MainMenu2=''; MainMenu3=''; MainMenu4=''; MainM2=''; SubM2_01=''; SubM2_02=''; SubM2_03='';">
                        ...
                        <li class="menu-item" :class="MainMenu3 + MainM3">
                            <router-link to="/cardplan" class="menu-link"
                                @click="MainMenu3?MainMenu3='' :MainMenu3='active'; MainMenu1=''; MainMenu2=''; MainMenu4=''; MainM2=''; SubM2_01=''; SubM2_02=''; SubM2_03='';">
                                <i class="menu-icon icon-base bx bx-credit-card"></i>
                                <div>ແຜນເບີກຈ່າຍບັດ</div>
                            </router-link>
                        </li>
                        <li class="menu-item" :class="MainMenu4 + MainM4">
                            <router-link to="/cardpurchases" class="menu-link"
                                @click="MainMenu4?MainMenu4='' :MainMenu4='active'; MainMenu1=''; MainMenu2=''; MainMenu3=''; MainM2=''; SubM2_01=''; SubM2_02=''; SubM2_03='';">
                                <i class="menu-icon icon-base bx bx-credit-card"></i>
                                <div>ການເບີກຈ່າຍບັດປະຈຳເດືອນ</div>
                            </router-link>
                        </li>
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item" :class="SubM2_01">
                                    <router-link to="/setting" href="javascript:void(0);" class="menu-link"
                                        @click="MainM2=' active', MainMenu1='', MainMenu3='', MainMenu4='', fmenu2(1)">
